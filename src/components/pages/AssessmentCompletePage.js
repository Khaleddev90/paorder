...
class AssessmentCompletePage extends Component {
    state = {
        orderItem: null,
        type: 'invoice_device',
        file: null,
    ...
    componentDidMount() {
        ...
        const originOrders = this.props.fulfilmentOrders.filter((item) => item.fulfilmentOrderState.key === 'ASSESSMENT' ||
            item.fulfilmentOrderState.key === 'RECEIVED' || 
    ...
    handlerProceedOrder = (e) => {
        history.push('/order-detail/' + this.props.match.params.qrcode + '/order')
    }
    
    handleGoDashboard = (e) => {
        history.push('/order-dashboard/ASSESSMENT')
    }
                                ...
                                <div className="ibox-content">
                                    <div className="row">
                                        ...
                                        <div className="col-lg-12 text-warning">
                                            <h2 className="float-right">{t('order.asses_complete')}</h2>
                                        </div>
                                        <div className="col-lg-12">
...
export default withNamespaces()(AssessmentCompletePage)
