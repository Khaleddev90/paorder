...
class ProcessingCompletePage extends Component {
    state = {
        orderItem: null,
        type: 'invoice_device',
        file: null,
    ...
    componentDidMount() {
        ...
        const originOrders = this.props.fulfilmentOrders.filter((item) => item.fulfilmentOrderState.key === 'APPROVED'|| 
    ...
    handleGoDashboard = (e) => {
        history.push('/order-dashboard/APPROVED')
    }
                            ...
                            {orderItem ? (
                                <div>
                                    ...
                                    <div className="ibox-content">
                                        <div className="row">
                                            <div className="col-lg-12">
                                                <i className="fa fa-smile fa-6x text-danger float-right"></i>
                                            </div>
                                            <div className="col-lg-12 text-danger">
                                                <h2 className="float-right">{t('order.processing_complete')}</h2>
                                            </div>
                                            <div className="col-lg-12">
                                                <button type="button" disabled={ nextDisable && beforeDisable } className="btn btn-danger btn-lg mt-5 float-right" 
                                                    onClick={ (e) => !nextDisable? this.handleGoRight(e): this.handleGoLeft() }>{t('order.process_next')} &gt;</button>
                                            </div>
                                            <div className="col-lg-12">
...
export default withNamespaces()(ProcessingCompletePage)
